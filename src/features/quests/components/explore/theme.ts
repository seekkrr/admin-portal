...
export interface TodTheme {
    // The Mapbox Standard `lightPreset` natively renders time-of-day colors AND
    // 3D-building shadows — no custom setLights needed (and custom lights would
    // override the preset's coordinated lighting). See setConfigProperty wiring.
